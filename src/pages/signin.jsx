    ...
    return(
        ...
        <Flex h={"100vh"} w={"100vw"} >
            <Flex w={{base:"100%", lg:"50%"}} m={"10rem"} direction="column" alignItems="center" justifyContent= "center">
               ...
               <FormControl>
                    <FormLabel ml={"0.3rem"} fontWeight={"semibold"} fontSize={"16px"}>
                        Username
                    </FormLabel>
                      
                        <Input type="text" w={"100%"} placeholder={"Enter your Username"}></Input>
                   
                    <FormLabel mt={"1.4rem"} ml={"0.3rem"} fontWeight={"semibold"} fontSize={"16px"}>
                        Password
                    </FormLabel>
                    
                    <Flex alignItems="center" justifyContent="right" >
                        <Input zIndex="0" position="absolute" type={eyeopen ? "text" : "password"} w={"100%"} placeholder={"............"}></Input>{eyeopen ? <AiFillEye onClick={()=>setEyeOpen(false)} size={"30px"} style={{paddingRight: "0.6rem" , color: "#0C8B28", cursor: 'pointer', zIndex: '10'}}></AiFillEye> : <AiFillEyeInvisible onClick={() => setEyeOpen(true)} size={"30px"} style={{paddingRight: "0.6rem", color: "#0C8B28", cursor: "pointer", zIndex: '10'}}></AiFillEyeInvisible>}
                    </Flex>
                    ...
                    <Link to={"/registerDetails"}>
                        <Button _active={{bg: "#0C8B28", color: "white"}} _hover={{bg:"white",color: "#0C8B28", borderColor: "#0C8B28", borderWidth: "1px"}} w="100%" bg="#0C8B28" color="white">
                            Log In
                        </Button>
                    </Link>
               </FormControl>
